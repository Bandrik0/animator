...
const Stage2D = forwardRef<HTMLCanvasElement>((props, ref) => {
  ...
  return (
    <Stage ref={ref as any} width={window.innerWidth - 480} height={window.innerHeight - 200} options={{ backgroundColor: 0x1e1e1e }}>
      {/* Background */}
      {bgUrl && (
        <Sprite image={bgUrl} x={0} y={0} width={window.innerWidth - 480} height={window.innerHeight - 200} />
      )}
